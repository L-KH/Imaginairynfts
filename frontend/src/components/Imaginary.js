    ...
    <div>
      ...
      <div className='form '>
        <form onSubmit={(e) => submitHandler(e, apiUrl)}>
          <input type="text" placeholder="Create a name(title)..." onChange={(e) => { setName(e.target.value) }} class="input input-bordered w-full max-w-xs" />
          <input type="text" placeholder="Create a description(public)..." onChange={(e) => setDescription(e.target.value)} class="input input-bordered w-full max-w-xs" />
